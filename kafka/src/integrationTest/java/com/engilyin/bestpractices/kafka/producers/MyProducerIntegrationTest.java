...
@TestPropertySource(
	properties = {"spring.config.location = classpath:application.yml, classpath:application-test.yml"})
class MyProducerIntegrationTest {
	...
	ConsumerFactory<String, MyMessage> consumerFactory = new DefaultKafkaConsumerFactory<>(
